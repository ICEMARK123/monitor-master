    ...
    $("#show_Line_btn").click(function () {
        ...
        $.post(url,data,function (result,status) {
            ...
            if(status=="success"){//"success".equals(status)
                ...
                var pfaList = result.pfaList;
                var pfbList = result.pfbList;
                var pfcList = result.pfcList;
                var pftList = result.pftList;
...
// 为echarts对象加载数据
                    ...
                    alert("没有此段时间的数据！");
                    window.location.href = contextpath + "/showReferInfo/showAllPowerFactor.power";
                }
            }
        },"json");
