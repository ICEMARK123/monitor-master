...
// 为echarts对象加载数据
                    ...
                    alert("没有此段时间的数据！");
                    window.location.href = contextpath + "/showReferInfo/showAllIImbalance.power";
                }
            }
        },"json");
                ...
                if (result.realTimeDatasList.length>0 ){
                    ...
                    for (var i = 0;i<result.realTimeDatasList.length;i++){
                        newtable += "<tr>" +
                            ...
                            "<td>"+result.realTimeDatasList[i].yi+"</td>" +
                            "</tr>";
                    }
