$(function(){
    ...
    $("#turnLineshow").click(function () {
        window.location.href="../admin/InfoLineShow.jsp?siteId="+siteId;
    });
    $("#tablePrint").click(function () {
        alert("您确定要打印吗？");
        headshow.style.display = 'none';
        showwaychoice.style.display = 'none';
        window.print();
        headshow.style.display = 'block';
        showwaychoice.style.display ='block';
    });
    $("#choicePara").click(function () {
        alert("参数选择");
    });
